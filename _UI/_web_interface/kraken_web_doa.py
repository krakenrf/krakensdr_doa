...
# --- Polar plot ---
        ...
        fig_type = []
        doa_max_str = ""
        if webInterface_inst.doa_thetas is not None and webInterface_inst.doa_results[
                0].size > 0:
            ...
            if webInterface_inst._doa_fig_type == 'Polar':
                thetas = np.append(
                    webInterface_inst.doa_thetas,
                    webInterface_inst.doa_thetas[0])
                result = np.append(
                ...
                result = np.append(
                    ...
                    webInterface_inst.doa_results[0][0])
                doa_max_str = (
                    360 - webInterface_inst.doas[0] + webInterface_inst.compass_offset) % 360
                update_data = dict(
                    theta=[
                        (360 - thetas + webInterface_inst.compass_offset) %
                        360], r=[result])
